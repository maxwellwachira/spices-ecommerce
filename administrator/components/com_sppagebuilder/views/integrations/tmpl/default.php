				...
				<div class="sp-pagebuilder-integrations">
						...
						<?php foreach ($integrations as $key => $item) : ?>
							...
							<div class="sp-pagebuilder-integration-list-item">
								<div>
									<img class="sp-pagebuilder-integration-thumbnail" src="<?php echo JURI::root(true) .'/administrator/components/com_sppagebuilder/assets/img/integrations/'. $item['group'] . '.png'; ?>" alt="<?php echo $item['title']; ?>">
