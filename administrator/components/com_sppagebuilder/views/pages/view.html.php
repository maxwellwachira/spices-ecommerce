...
class SppagebuilderViewPages extends JViewLegacy {
	...
	public function display( $tpl = null ) {
		...
		/**
		 * Enable and run maintenance audit
		 *
		 * @since	3.7.5
		*/
	...
	protected function addToolBar() {
		...
		// Set the title
		ToolbarHelper::title(Text::_('COM_SPPAGEBUILDER') . ' - ' . JText::_('COM_SPPAGEBUILDER_PAGES'), 'none pbfont pbfont-pagebuilder');
