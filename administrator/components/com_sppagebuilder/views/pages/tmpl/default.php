...
<div class="sp-pagebuilder-admin">
	...
	<div class="sp-pagebuilder-main">
		...
		<div class="sp-pagebuilder-content">
			<form action="<?php echo JRoute::_('index.php?option=com_sppagebuilder&view=pages');?>" method="post" name="adminForm" id="adminForm">
				...
				<?php if($this->databaseIssue) : ?>
					<div class="alert alert-warning">
						...
						<a class="btn btn-primary" href="<?php echo JRoute::_('index.php?option=com_sppagebuilder&view=maintenance', false); ?>">Update SP Page Builder Database</a>
					</div>
				<?php endif; ?>
