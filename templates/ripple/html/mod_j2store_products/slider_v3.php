...
<div class="jowl-module-product-slide">
	...
	<?php foreach($list as $item):
		...
		$cart_text = JText::_('J2STORE_ADD_TO_CART');
			...
			?>
		<div class="item j2product j2store_product_block j2store-single-product">
					...
					<div class="j2store_product_image_block" style="<?php echo $style;?>">
						<span class="j2store_product_image">
							...
							<img
								...
								style="width:<?php echo $params->get('image_size_width');?>; height:<?php echo $params->get('image_size_height');?>"
								/>
							</a>
						</span>
						...
						<div class="j2store-quickview center" itemscope>
