...
<div id="k2Container" class="userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemAuthorBlock userBlock">
   <div class="itemAuthorDetails">
	...
	<div class="userItemList">
		...
		<div class="userItemView<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' userItemViewUnpublished'; ?><?php echo ($item->featured) ? ' userItemIsFeatured' : ''; ?>">
			...
			<!-- Item Image -->
			<div class="catItemImageBlock userItemImageBlock">
			 <span class="catItemImage userItemImage">
			...
			<div class="itemHeader userItemHeader">			
			  ...
			  <!-- Item title -->
			  <h2 class="itemTitle userItemTitle">
        ...
        <ul class="itemToolbar">          
			...
			<!-- Date created -->
			<li>
		 		<?php echo JHTML::_('date', $item->created, "M j, Y"); ?>
			</li>
			<?php endif; ?>
		  ...
		  <div class="catItemBody userItemBody">
			  ...
			  <!-- Item introtext -->
			  <div class="catItemIntroText userItemIntroText">
		  ...
		  <div class="userItemTagsBlock itemLinks itemTagsBlock">
		  ...
		  <?php endif; ?>
			...
			<!-- Item "read more..." link -->
			<div class="userItemReadMore k2PushRight">
