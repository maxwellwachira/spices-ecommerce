...
<div class="catItemView smaller-thumbnail group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <!-- Item video -->
  <div class="itemVideoBlock catItemVideoBlock">
  ...
  <?php if(empty($this->item->video) && ($this->item->params->get('catItemImage') && !empty($this->item->image))): ?>
  <!-- Item Image -->
  ...
  <?php endif; ?>
    ...
    <ul class="itemToolbar">
		...
		<!-- Date created -->
		<li>
			<?php echo JHTML::_('date', $this->item->created, "M j, Y"); ?>
		</li>
		<?php endif; ?>
		...
		<li>
			...
			<?php else: ?>
				...
				<a href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
					<?php echo JText::_('<i class="fa fa-comments-o"></i>'); ?><?php echo $this->item->numOfComments; ?>
				</a>
				<?php else: ?>
				<a href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
					<?php echo JText::_('<i class="fa fa-comments-o"></i>'); ?><?php echo $this->item->numOfComments; ?> 
