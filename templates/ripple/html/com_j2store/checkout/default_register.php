...
//we dont have a profile set in the store profile. So use the default one.
	...
	<div class="col-sm-6">[first_name] [last_name] [email] [phone_1] [phone_2] [password] [confirm_password]</div>
	<div class="col-sm-6">[company] [tax_number] [address_1] [address_2] [city] [zip] [country_id] [zone_id]</div>
	</div>';
}
...
$password .='<span class="j2store_field_required">*</span><label>'.JText::_('J2STORE_CHECKOUT_ENTER_PASSWORD').'</label>';
$password .='<input type="password" name="password" value="" class="inputbox" />';
$confirm_password= '<span class="j2store_field_required">*</span><label>'.JText::_('J2STORE_CHECKOUT_CONFIRM_PASSWORD').'</label>
  <input type="password" name="confirm" value="" class="inputbox" />';
...
<?php endif; ?>
  ...
  <div class="row-fluid">
  <div class="col-sm-12 shipping-make-same">
