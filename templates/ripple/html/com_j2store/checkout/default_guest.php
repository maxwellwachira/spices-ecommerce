...
defined( '_JEXEC' ) or die( 'Restricted access' );
	...
	if(empty($html) || JString::strlen($html) < 5) {
		...
		<div class="col-sm-6">[first_name] [last_name] [email] [phone_1] [phone_2] [country_id] [zone_id] </div>
		<div class="col-sm-6">[company] [tax_number] [address_1] [address_2] [city] [zip] </div>
		</div>';
	}
