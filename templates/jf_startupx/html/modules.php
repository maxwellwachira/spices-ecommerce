...
function modChrome_jfxhtmlswappers($module, &$params, &$attribs)
{
	$moduleTag     = $params->get('module_tag', 'div');
	$bootstrapSize = (int) $params->get('bootstrap_size', 0);
	...
	if ($module->content)
	{
		...
		echo '<div class="swappers-table"><div class="helper"><div class="swappers-content">';
...
function modChrome_jfxhtml($module, &$params, &$attribs)
{
	$moduleTag     = $params->get('module_tag', 'div');
	$bootstrapSize = (int) $params->get('bootstrap_size', 0);
	$moduleClass   = $bootstrapSize != 0 ? 'col-lg-' . $bootstrapSize : 'col-sm-12';
	$headerTag     = htmlspecialchars($params->get('header_tag', 'h3'));
	$headerClass   = htmlspecialchars($params->get('header_class', 'module-title'));
